<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a href="{{route('dashboard')}}"><i class="la la-home"></i><span class="menu-title" data-i18n="Dashboard Hospital">Dashboard</span></a>
            </li>


            <li class=" nav-item"><a href="{{route('point')}}"> <i class="las la-award"></i><span class="menu-title" data-i18n="Doctors">Points</span></a>

            </li>

            <li class=" nav-item"><a href="{{route('summary')}}"><i class="la la-trophy"></i><span class="menu-title" data-i18n="Patients">Leaderboard</span></a>
            ...
            <li class="active"><a href="app-chat.html"><i class="la la-comments"></i><span class="menu-title" data-i18n="Chat">Chat</span></a>
            </li>
