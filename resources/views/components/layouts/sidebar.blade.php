 ...
 <div class="iconsidebar-menu">
     <div class="sidebar">
         <ul class="iconMenu-bar custom-scrollbar">
             <li><a class="bar-icons" href="{{route('dashboard')}}">
                     <!--img(src='../assets/images/menu/home.png' alt='')--><i class="pe-7s-home"></i><span>General
                     </span></a>
             ...
             <li><a class="bar-icons" href="{{route('point')}}"><i class="pe-7s-medal"></i><span>Points
                         </span></a>
                 {{-- <ul class="iconbar-mainmenu custom-scrollbar">
             ...
             <li><a class="bar-icons" href="{{route('summary')}}"><i
                         class="pe-7s-cup"></i><span>Leaderboard</span></a>
                 {{-- <ul class="iconbar-mainmenu custom-scrollbar">
